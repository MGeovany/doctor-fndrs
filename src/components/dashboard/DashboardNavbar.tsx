      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            {onOpenSidebar && (
              <button
                className="mr-2 flex items-center justify-center rounded-md p-2 text-gray-700 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-inset lg:hidden"
            ...
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-jakarta text-md ml-2 hidden text-gray-500 sm:inline">
                DASHBOARD
              </span>
            </Link>
          </div>
