      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-2 md:grid-cols-2">
          ...
          <div className="gsap-slide-in-left relative flex w-full justify-center">
            ...
            {/* Floating card */}
            <div className="gsap-rotate-in absolute -bottom-8 left-1/2 flex w-72 -translate-x-1/2 items-center gap-4 rounded-2xl border border-gray-100 bg-white px-6 py-4 shadow-xl">
          ...
          {/* Right: Text content */}
          <div className="gsap-slide-in-right flex h-full flex-col justify-center gap-8 rounded-3xl bg-gradient-to-b from-white to-blue-100 p-10">
            <div className="mb-4">
