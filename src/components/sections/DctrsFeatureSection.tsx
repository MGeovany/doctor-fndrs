      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-6 sm:gap-2 md:grid-cols-2">
          <div className="relative flex w-full justify-center">
            ...
            <div className="absolute -bottom-8 left-1/2 flex w-56 -translate-x-1/2 items-center gap-3 rounded-2xl border border-gray-100 bg-white px-4 py-3 shadow-xl sm:w-72 sm:gap-4 sm:px-6 sm:py-4">
          ...
          <div className="flex h-full flex-col justify-center gap-6 rounded-3xl bg-gradient-to-b from-white to-blue-100 p-6">
